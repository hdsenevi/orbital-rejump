...
func change_screen(new_screen):
	if current_screen:
		var scene_tree_tween = current_screen.disappear()
		yield(scene_tree_tween, "finished")
	
	current_screen = new_screen
	
	if new_screen:
		var scene_tree_tween = current_screen.appear()
		yield(scene_tree_tween, "finished")
...
func game_over(score, highscore):
	...
	score_box.get_node("HighScore").text = "High Score: %s" % highscore
